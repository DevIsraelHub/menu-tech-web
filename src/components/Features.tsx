    ...
    <div className="w-full flex flex-col items-center justify-center mt-20 brandPadding max-w-[1200px] mx-auto">
      ...
      <div className="space-y-12">
        {features.map((feature, index) => (
          <div key={index} className={`w-full flex ${feature.reverse ? 'max-sm:flex-col-reverse' : 'max-sm:flex-col'} gap-y-6 items-center justify-start sm:justify-between`}>
            {!feature.reverse && (
      ...
      <Button className="rounded-full w-[200px] h-[50px] bg-[#f2f2f2] border-2 text-[#f15a2a] border-primary p-4 mb-10 mt-6">
        See more
      </Button>
    </div>
  );
