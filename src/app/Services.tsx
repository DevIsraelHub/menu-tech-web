...
const Services: React.FC = () => {
  ...
  return (
    <div className="flex flex-col text-center items-center  justify-center pl-20 pr-20">
      <div className="">
        <h2 className="text-4xl font-bold text-[#1e1e1e] mt-[200px] md:text-4xl">
          MenuTech For You
        </h2>
        <h4 className="text-xl text-[#f89222] justify-between mt-4 md:text-2xl font-semibold">
          Explore new features with the newly MenuTech
        </h4>

        <div className="w-full grid grid-cols-1 gap-x-40 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col items-center p-4">
            ...
            <h4 className="text-2xl text-[#f89222] font-semibold w-[300px]">
              Menu Management
            </h4>
            <p className="w-[360px]">
          ...
          <div className="flex flex-col items-center p-4">
            ...
            <h4 className="text-2xl text-[#f89222] font-semibold w-[300px]">AI Support 24/7</h4>
            <p className="w-[360px]">
