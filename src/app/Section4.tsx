                    ...
                    <div className="flex gap-5 pb-5 pl-10">
                      {
                        socialLink.map((item, index) => (
                          <Link href={item.href} key={index} target="_blank" className="text-[#f2f2f2] cursor-pointer">
                            {item.icon}
                          </Link>
                        ))
                      }
                  ...
                  <ul>
                    <p className="text-white font-bold text-xl pb-6">Contact Us</p>
                    {
                      contact.map((item, index) => (
                        <Link href={item.href} className="flex items-center gap-x-3 text-[#f2f2f2] text-sm pb-4 hover:underline hover:text-[#f89222] cursor-pointer" key={index}>
                          {item.icon}
                          <p>{item.name}</p>
                        </Link>
                      ))
